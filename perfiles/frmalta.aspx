...
<asp:Content ID="evalMainC" runat="server" ContentPlaceHolderID="mainBodyContent">
    ...
    <div class="btn-group hidden-print" role="group">          
        ...
        <asp:button id="btnRegistrar" runat="server" CssClass="btn btn-default" Text="Registrar perfil de alta" CausesValidation="false" OnClientClick="return validate();" onclick="btnRegistrar_Click" />

  ...
  <div class="panel-body">
    ...
    <div class="row Participa">
        <div class="col-lg-12 SEPSDivs"><%--Fecha de Entrada--%>
            ...
            <div class="leftFloat">
                <asp:DropDownList  CssClass="form-control" ID="ddlFechaEntradaMes" runat="server" onChange="TakeHomeFechaEntrada()">
            ...
            <div class="leftFloat">
                <asp:DropDownList CssClass="form-control" ID="ddlFechaEntradaDía" runat="server" onChange="TakeHomeFechaEntrada()">
        ...
        <div class="col-lg-12 SEPSDivs"><%--Fecha de Salida--%>
            ...
            <div class="leftFloat">
                <asp:DropDownList CssClass="form-control" ID="ddlFechaSalidaMes" onChange="TakeHomeFechaSalida()" runat="server">
                    <asp:ListItem Value="1">Enero</asp:ListItem>
                    <asp:ListItem Value="2">Febrero</asp:ListItem>
                    <asp:ListItem Value="3">Marzo</asp:ListItem>
                    <asp:ListItem Value="4">Abril</asp:ListItem>
            ...
            <div class="leftFloat">
                <asp:DropDownList CssClass="form-control" ID="ddlFechaSalidaDía" runat="server" onChange="TakeHomeFechaSalida()">
                    <asp:ListItem Value="1">1</asp:ListItem>
                    <asp:ListItem Value="2">2</asp:ListItem>
                    <asp:ListItem Value="3">3</asp:ListItem>
                    <asp:ListItem Value="4">4</asp:ListItem>

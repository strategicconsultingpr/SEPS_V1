    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-print-12 col-md-6 SEPSDivs">
                ...
                <div class="expandibleDiv">
                    <asp:DropDownList CssClass="form-control" ID="ddlNoFueraLaboral" runat="server" DataTextField="DE_NoFuerzaLaboral" DataValueField="PK_NoFuerzaLaboral" DataSource="<%# dvwFuerzaLaboral %>" />
    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-print-12 col-md-6 SEPSDivs">
                ...
                <div class="expandibleDiv">
                    <asp:DropDownList CssClass="form-control" ID="ddlFuenteIngreso" runat="server" DataTextField="DE_FuenteIngreso" DataValueField="PK_FuenteIngreso" DataMember="SA_LKP_TEDS_FUENTE_INGRESO" DataSource="<%# dsPerfil %>" />
        ...
        <div class="row">
            <div class="col-print-6 col-md-6 SEPSDivs">
                ...
                <div class="expandibleDiv">
                    <asp:DropDownList CssClass="form-control" ID="ddlResidencia" runat="server" DataTextField="DE_Residencia" DataValueField="PK_Residencia" DataMember="SA_LKP_TEDS_RESIDENCIA" DataSource="<%# dsPerfil %>" />

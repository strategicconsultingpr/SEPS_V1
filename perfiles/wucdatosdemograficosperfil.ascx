  ...
  <div class="panel-body">
   <div class="row">
    ...
    <div class="col-md-6 SEPSDivs"><%--Si no participa en la fuerza laboral--%>
        ...
        <div class="expandibleDiv">
            <asp:DropDownList  CssClass="form-control" ID="ddlNoFueraLaboral" runat="server" DataSource="<%# dvwFuerzaLaboral %>" DataValueField="PK_NoFuerzaLaboral" DataTextField="DE_NoFuerzaLaboral"/>
...
<div class="row">
    ...
    <div class="col-md-6 SEPSDivs"><%--Residencia--%>
       ...
       <asp:RequiredFieldValidator ID="rfvResidencia"  CssClass="rightFloatAsterisk"  runat="server" Display="Dynamic" ControlToValidate="ddlResidencia" ErrorMessage="Residencia" ToolTip="Seleccione un valor de la lista. Este campo es requerido." InitialValue="0" Text="*"/>
        <div class="expandibleDiv">
            <asp:DropDownList  CssClass="form-control"  ID="ddlResidencia" runat="server" DataSource="<%# dsPerfil %>" DataMember="SA_LKP_TEDS_RESIDENCIA" DataValueField="PK_Residencia" DataTextField="DE_Residencia"/>

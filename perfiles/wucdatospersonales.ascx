    ...
    <div class="col-print-6 col-sm-6 col-lg-3 SEPSDivsInfo"><%-- Grupo Etnico --%>
        ...
        <div class="row">
            <div class="col-lg-6 SEPSDivs"><%-- Fecha de Admision  --%>
                ...
                <div class="leftFloat">
                    <asp:DropDownList  CssClass="form-control" Width="120px" ID="ddlMes" runat="server" onChange="ddlMesNuevo('WucDatosPersonales_')">
                ...
                <div class="leftFloat">
                    <asp:DropDownList  CssClass="form-control" Width="65px"  ID="ddlDía" runat="server" onChange="ddlDíaNuevo('WucDatosPersonales_')">
                ...
                <div class="leftFloat">
                    <asp:TextBox  CssClass="form-control"  ID="txtAño" runat="server"  onBlur="FechaAdmision('WucDatosPersonales_ddlMes', 'WucDatosPersonales_ddlDía', 'WucDatosPersonales_txtAño', 'WucDatosPersonales_ddlMesHidden', 'WucDatosPersonales_lblFENacimientoHidden', 'WucDatosPersonales_lblFENacimiento', 'WucDatosPersonales_ddlDíaHidden', 'WucDatosPersonales_txtAñoHidden')" MaxLength="4" Width="60px" AutoPostBack="True" OnTextChanged="txtAño_TextChanged1"/>
                </div>
            ...
            <div id="divFechaConvenio" runat="server" class="col-md-6 SEPSDivs"><%-- Fecha de Convenio --%>
                ...
                <div class="leftFloat">
                    <asp:DropDownList  CssClass="form-control" ID="ddlFechaConvenioMes" onBlur="FechaConvenio()" runat="server">
                        <asp:ListItem Value="1">Enero</asp:ListItem>
                        <asp:ListItem Value="2">Febrero</asp:ListItem>
                        <asp:ListItem Value="3">Marzo</asp:ListItem>
                        <asp:ListItem Value="4">Abril</asp:ListItem>
                ...
                <div class="leftFloat">
                <asp:DropDownList  CssClass="form-control"  ID="ddlFechaConvenioDía" runat="server" onBlur="FechaConvenio()">
                    <asp:ListItem Value="1">1</asp:ListItem>
                    <asp:ListItem Value="2">2</asp:ListItem>
                    <asp:ListItem Value="3">3</asp:ListItem>
                    <asp:ListItem Value="4">4</asp:ListItem>

...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <div class="col-md-12 SEPSDivs"><%--Usa metadona como parte del tratamiento?--%>
        ...
        <div class="expandibleDiv">
        <asp:DropDownList CssClass="form-control" ID="ddlMetadona" runat="server">
  ...
  <div class="panel-body">
   <div class="row">
    ...
    <div class="col-md-6 SEPSDivs"><%--Ha sido arrestado anteriormente--%>
        ...
        <div class="expandibleDiv">
            <asp:DropDownList  CssClass="form-control" ID="ddlArrestado" runat="server" onChange="ddlArrestado();">
                <asp:ListItem></asp:ListItem>
                <asp:ListItem Value="1">Sí</asp:ListItem>
                <asp:ListItem Value="2">No</asp:ListItem>
            </asp:DropDownList>
    ...
    <ContentTemplate>
        ...
        <div class="row">
            <div class="col-md-12 SEPSDivs"><%--Existe historial de maltrato en la niñez?--%>
                ...
                <div class="expandibleDiv">
                <asp:DropDownList CssClass="form-control"  ID="ddlMaltratoNinez" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlMaltratoNinez_SelectedIndexChanged">
                    <asp:ListItem />
                    <asp:ListItem Value="1">Sí</asp:ListItem>
                    <asp:ListItem Value="2">No</asp:ListItem>
                    <asp:ListItem Value="94">No recuerda</asp:ListItem>
...
<div class="panel panel-default">
  ...
  <div class="table-panel-body">
    ...
    <tr>
        ...
        <td> 
            ...
            <div class="expandibleDiv">
                ...
                <asp:HyperLink ID="hlDSMVClinPrim" ForeColor="DarkGreen" runat="server" NavigateUrl="javascript:showDSMV('mainBodyContent_WucEpisodioAdmision_txtDSMVClinPrim', 'mainBodyContent_WucEpisodioAdmision_hDSMVClinPrim')">Buscar...</asp:HyperLink>
        ...
        <td>
            ...
            <div class="expandibleDiv">
                ...
                <asp:HyperLink ID="hlDSMVClinSec" ForeColor="DarkGreen" runat="server" NavigateUrl="javascript:showDSMV('mainBodyContent_WucEpisodioAdmision_txtDSMVClinSec', 'mainBodyContent_WucEpisodioAdmision_hDSMVClinSec')">Buscar...</asp:HyperLink>
        ...
        <td>
            ...
            <div class="expandibleDiv">
                ...
                <asp:HyperLink ID="hlDSMVClinTer" ForeColor="DarkGreen" runat="server" NavigateUrl="javascript:showDSMV('mainBodyContent_WucEpisodioAdmision_txtDSMVClinTer', 'mainBodyContent_WucEpisodioAdmision_hDSMVClinTer')">Buscar...</asp:HyperLink>
    ...
    <tr>
        ...
        <td>
            ...
            <div class="expandibleDiv">
                ...
                <asp:HyperLink ID="hlDSMVRMPrim" ForeColor="DarkGreen" runat="server" NavigateUrl="javascript:showDSMV('mainBodyContent_WucEpisodioAdmision_txtDSMVRMPrim', 'mainBodyContent_WucEpisodioAdmision_hDSMVRMPrim')">Buscar...</asp:HyperLink>
        ...
        <td>
            ...
            <div class="expandibleDiv">
                ...
                <asp:HyperLink ID="hlDSMVRMSec" ForeColor="DarkGreen" runat="server" NavigateUrl="javascript:showDSMV('mainBodyContent_WucEpisodioAdmision_txtDSMVRMSec', 'mainBodyContent_WucEpisodioAdmision_hDSMVRMSec')">Buscar...</asp:HyperLink>
        ...
        <td>
            ...
            <div class="expandibleDiv">
                ...
                <asp:HyperLink ID="hlDSMVRMTer" ForeColor="DarkGreen" runat="server" NavigateUrl="javascript:showDSMV('mainBodyContent_WucEpisodioAdmision_txtDSMVRMTer', 'mainBodyContent_WucEpisodioAdmision_hDSMVRMTer')">Buscar...</asp:HyperLink>
    ...
    <tr>
        ...
        <td colspan="3">
            <asp:textbox CssClass="form-control" id="txtDSMVFnGlobal" runat="server" MaxLength="3" Width="100%"/>
  ...
  <div class="table-panel-body">
    ...
    <tr>
        ...
        <td><%--Diagnóstico Primario--%>
            ...
            <div class="expandibleDiv">
                <asp:DropDownList  CssClass="form-control" ID="ddlFrecPrim" runat="server" DataSource="<%# dvwFrecPrim %>" DataTextField="DE_Frecuencia" DataValueField="PK_Frecuencia"/>
        ...
        <td><%--Diagnóstico Secundario--%>
            ...
            <div class="expandibleDiv">
                <asp:DropDownList  CssClass="form-control" ID="ddlFrecSec" runat="server" DataSource="<%# dvwFrecSec %>" DataTextField="DE_Frecuencia" DataValueField="PK_Frecuencia"/>
        ...
        <td><%--Diagnóstico Terciario--%>
            ...
            <div class="expandibleDiv">
                <asp:DropDownList CssClass="form-control"  ID="ddlFrecTerc" runat="server" DataSource="<%# dvwFrecTerc %>" DataTextField="DE_Frecuencia" DataValueField="PK_Frecuencia"/>

  ...
  <div class="table-panel-body">
    ...
    <tr>
        ...
        <td> 
            ...
            <asp:HyperLink ID="hlDSMVClinPrim" ForeColor="DarkGreen" runat="server" NavigateUrl="javascript:showDSMV('mainBodyContent_WucEpisodioPerfil_txtDSMVClinPrim', 'mainBodyContent_WucEpisodioPerfil_hDSMVClinPrim')" Text="Buscar..."/>
        ...
        <td>
            ...
            <asp:HyperLink ID="hlDSMVClinSec" ForeColor="DarkGreen" runat="server" NavigateUrl="javascript:showDSMV('mainBodyContent_WucEpisodioPerfil_txtDSMVClinSec', 'mainBodyContent_WucEpisodioPerfil_hDSMVClinSec')" Text="Buscar..."/>
        ...
        <td>
            ...
            <asp:HyperLink ID="hlDSMVClinTer" ForeColor="DarkGreen" runat="server" NavigateUrl="javascript:showDSMV('mainBodyContent_WucEpisodioPerfil_txtDSMVClinTer', 'mainBodyContent_WucEpisodioPerfil_hDSMVClinTer')" Text="Buscar..."/>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:HyperLink ID="hlDSMVRMPrim" ForeColor="DarkGreen" runat="server" NavigateUrl="javascript:showDSMV('mainBodyContent_WucEpisodioPerfil_txtDSMVRMPrim', 'mainBodyContent_WucEpisodioPerfil_hDSMVRMPrim')" Text="Buscar..."/>
        ...
        <td>
            ...
            <asp:HyperLink ID="hlDSMVRMSec" ForeColor="DarkGreen" runat="server" NavigateUrl="javascript:showDSMV('mainBodyContent_WucEpisodioPerfil_txtDSMVRMSec', 'mainBodyContent_WucEpisodioPerfil_hDSMVRMSec')" Text="Buscar..."/>
        ...
        <td>
            ...
            <asp:HyperLink ID="hlDSMVRMTer" ForeColor="DarkGreen" runat="server" NavigateUrl="javascript:showDSMV('mainBodyContent_WucEpisodioPerfil_txtDSMVRMTer', 'mainBodyContent_WucEpisodioPerfil_hDSMVRMTer')" Text="Buscar..."/>
    ...
    <tr>
        ...
        <td colspan="3">
            <asp:textbox CssClass="form-control" id="txtDSMVFnGlobal" runat="server" MaxLength="3"/>

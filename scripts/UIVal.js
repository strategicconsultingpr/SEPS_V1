...
function ddlMesNuevo(wuc, postfix) {
    try {
...
function ddlDíaNuevo(wuc, postfix) {
    try {
        if (typeof (postfix) == "undefined") {
            postfix = "";
        }
...
function FechaConvenio() {
    try {
        var esProgramaAdulto = document.getElementById("mainBodyContent_WucDatosPersonales_ddlFechaConvenioMes");
